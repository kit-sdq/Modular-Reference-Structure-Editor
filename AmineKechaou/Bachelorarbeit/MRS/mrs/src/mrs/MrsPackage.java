...
public interface MrsPackage extends EPackage {
	...
	/**
     * The feature id for the '<em><b>Visible EClassifiers</b></em>' reference list.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
	int METAMODEL__VISIBLE_ECLASSIFIERS = 1;

	/**
     * The feature id for the '<em><b>Visible EPackages</b></em>' reference list.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @generated
     * @ordered
     */
	int METAMODEL__VISIBLE_EPACKAGES = 2;
	...
	/**
     * Returns the meta object for the reference list '{@link mrs.Metamodel#getVisibleEClassifiers <em>Visible EClassifiers</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @return the meta object for the reference list '<em>Visible EClassifiers</em>'.
     * @see mrs.Metamodel#getVisibleEClassifiers()
     * @see #getMetamodel()
     * @generated
     */
	EReference getMetamodel_VisibleEClassifiers();

	/**
     * Returns the meta object for the reference list '{@link mrs.Metamodel#getVisibleEPackages <em>Visible EPackages</em>}'.
     * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
     * @return the meta object for the reference list '<em>Visible EPackages</em>'.
     * @see mrs.Metamodel#getVisibleEPackages()
     * @see #getMetamodel()
     * @generated
     */
	EReference getMetamodel_VisibleEPackages();
	...
	interface Literals {
		...
		/**
         * The meta object literal for the '<em><b>Visible EClassifiers</b></em>' reference list feature.
         * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
         * @generated
         */
		EReference METAMODEL__VISIBLE_ECLASSIFIERS = eINSTANCE.getMetamodel_VisibleEClassifiers();

		/**
         * The meta object literal for the '<em><b>Visible EPackages</b></em>' reference list feature.
         * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
         * @generated
         */
		EReference METAMODEL__VISIBLE_EPACKAGES = eINSTANCE.getMetamodel_VisibleEPackages();
